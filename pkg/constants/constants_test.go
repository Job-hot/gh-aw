...
func TestConstantValues(t *testing.T) {
	tests := []struct {
		...
		{"AwInfoArtifactName", AwInfoArtifactName, "aw-info"},
		{"LegacyAwInfoArtifactName", LegacyAwInfoArtifactName, "aw_info"},
		{"PromptArtifactName", PromptArtifactName, "prompt"},
		{"SafeOutputArtifactName", SafeOutputArtifactName, "safe-output"},
		{"LegacySafeOutputArtifactName", LegacySafeOutputArtifactName, "safe_output"},
		{"AgentOutputArtifactName", AgentOutputArtifactName, "agent-output"},
		{"LegacyAgentOutputArtifactName", LegacyAgentOutputArtifactName, "agent_output"},
		{"AwInfoFilename", AwInfoFilename, "aw_info.json"},
		{"SafeOutputRawFilename", SafeOutputRawFilename, "safe_output.jsonl"},
		{"AgentOutputFilename", AgentOutputFilename, "agent_output.json"},
		{"PromptFilename", PromptFilename, "prompt.txt"},

...
func TestDetectKnownCredentialLeakingActions(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: map[string]struct{}{"GH_AW_CLEAN_GCP": struct{}{}},
		},
		{
			...
			expected: map[string]struct{}{"GH_AW_CLEAN_AWS": struct{}{}},
		},
		{
			...
			expected: map[string]struct{}{"GH_AW_CLEAN_AZURE": struct{}{}},
		},
		{
			...
			expected: map[string]struct{}{"GH_AW_CLEAN_DOCKER": struct{}{}},
		},
		{
		...
		},
		{
			...
			expected: map[string]struct{}{"GH_AW_CLEAN_SSH": struct{}{}},
		},
		{
		...
		},
		{
			...
			expected: map[string]struct{}{
				"GH_AW_CLEAN_AWS":    struct{}{},
				"GH_AW_CLEAN_DOCKER": struct{}{},
			},
		},
		{
			...
			expected: map[string]struct{}{
				"GH_AW_CLEAN_GCP":    struct{}{},
				"GH_AW_CLEAN_AWS":    struct{}{},
				"GH_AW_CLEAN_AZURE":  struct{}{},
				"GH_AW_CLEAN_DOCKER": struct{}{},
				"GH_AW_CLEAN_SSH":    struct{}{},
			},
		},
		{
...
func TestMergeKnownActionEnvVars(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "one nil",
			a:        map[string]struct{}{"GH_AW_CLEAN_GCP": struct{}{}},
			b:        nil,
			expected: map[string]struct{}{"GH_AW_CLEAN_GCP": struct{}{}},
		},
		{
			...
			a:        map[string]struct{}{"GH_AW_CLEAN_GCP": struct{}{}},
			b:        map[string]struct{}{"GH_AW_CLEAN_AWS": struct{}{}},
			expected: map[string]struct{}{"GH_AW_CLEAN_GCP": struct{}{}, "GH_AW_CLEAN_AWS": struct{}{}},
		},
		{
			name:     "both populated, with overlap",
			a:        map[string]struct{}{"GH_AW_CLEAN_GCP": struct{}{}, "GH_AW_CLEAN_AWS": struct{}{}},
			b:        map[string]struct{}{"GH_AW_CLEAN_AWS": struct{}{}, "GH_AW_CLEAN_AZURE": struct{}{}},
			expected: map[string]struct{}{"GH_AW_CLEAN_GCP": struct{}{}, "GH_AW_CLEAN_AWS": struct{}{}, "GH_AW_CLEAN_AZURE": struct{}{}},
		},
	}
